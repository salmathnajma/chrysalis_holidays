...
$panels = array(
    ...
    'maintenance' => array(
        'title' => __("Maintenance", "gd-rating-system"), 'icon' => 'sliders',
...
$panels+= array(
    ...
    'widgets' => array(
        'title' => __("Widgets", "gd-rating-system"), 'icon' => 'puzzle-piece',
        'info' => __("From this panel you disable widgets you don't need.", "gd-rating-system")),
    'jscss' => array(
        'title' => __("JS / CSS Loading", "gd-rating-system"), 'icon' => 'toggle-on',
