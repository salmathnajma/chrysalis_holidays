    ...
    <tbody>
        <tr>
            <td class="cell-left">
                ...
                <?php d4p_render_select(gdrts_admin_shared::data_list_templates('like-this'), array('id' => $this->get_field_id('template'), 'class' => 'widefat', 'name' => $this->get_field_name('template'), 'selected' => $instance['template'])); ?>
            </td>
            <td class="cell-right">
