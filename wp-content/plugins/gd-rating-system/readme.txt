...
Version: 3.1.3
Tags: dev4press, stars, rating, like, rate posts, rate, vote
...
= Version 3.0 Upgrade =
Make sure to follow the instructions provided on the plugin Update screen that will be displayed when you update the plugin. If you don't upgrade the database, you will not be able to use the plugin or receive votes, and any existing votes and ratings will be hidden until the upgrade is completed.
...
* Addon: Shortcake UI Plugin Support (v1.4 - now deprecated)
* Widget: Rating block
* Widget: Rating list
...
= PHP Notice =
* Plugin should work with PHP 5.4 and 5.5, but these versions are no longer used for testing, and they are no longer supported.
* Plugin doesn't work with PHP 5.3 or older versions.
...
== Upgrade Notice ==
= 3.1 =
Shortcodes Builder. Rich Snippets improvements. Posts integration improvements. Many bug fixes.
