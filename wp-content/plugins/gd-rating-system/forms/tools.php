...
$panels = array(
    ...
    'snippets' => array(
        'title' => __("Update Rich Snippets", "gd-rating-system"), 'icon' => 'flag',
        'button' => 'submit', 'button_text' => __("Update", "gd-rating-system"),
    ...
    'dbfour' => array(
        'title' => __("Database 3.0", "gd-rating-system"), 'icon' => 'database',
        'break' => __("Upgrade", "gd-rating-system"),
        'button' => 'button', 'button_text' => __("Upgrade", "gd-rating-system"),
