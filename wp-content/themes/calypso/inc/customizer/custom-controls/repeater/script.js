		...
		theme_conrols.on(
			'change', '.customizer-repeater-image-choice', function () {
				if (jQuery( this ).val() === 'customizer_repeater_image') {
					...
					jQuery( this ).parent().parent().find( '.customizer-repeater-color2-control' ).prev().prev().hide();
					jQuery( this ).parent().parent().find( '.customizer-repeater-color2-control' ).hide();
				...
				if (jQuery( this ).val() === 'customizer_repeater_icon') {
					...
					jQuery( this ).parent().parent().find( '.customizer-repeater-color2-control' ).prev().prev().show();
					jQuery( this ).parent().parent().find( '.customizer-repeater-color2-control' ).show();
				}
