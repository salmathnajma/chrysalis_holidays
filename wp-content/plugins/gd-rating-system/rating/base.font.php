...
abstract class gdrts_font {
    ...
    public function actions() {
        ...
        if (in_array('like-this', $this->active)) {
            ...
            add_filter('gdrts_shortcake_attrs_like_this', array($this, 'shortcake_like_this'));
            add_filter('gdrts_shortcake_attrs_like_this_auto', array($this, 'shortcake_like_this'));
            add_filter('gdrts_shortcake_attrs_like_this_list', array($this, 'shortcake_like_this'));
        }
    ...
    public function shortcake_like_this($attrs) {
        $item = array(
            'label' => $this->label,
            'attr' => $this->option_name(),
            'type' => 'select',
