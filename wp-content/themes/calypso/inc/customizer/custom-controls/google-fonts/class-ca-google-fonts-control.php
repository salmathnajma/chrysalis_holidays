<?php
/**
 * Custom control for google fonts selection
 *
 * @package calypso
 */
if ( class_exists( 'WP_Customize_Control' ) ) {

    class Ca_Google_Fonts_Control extends WP_Customize_Control {
        /**
		...
		public function enqueue() {
			wp_enqueue_script( 'ca-select2-js', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js', array( 'jquery' ), '4.0.6', true );
			wp_enqueue_script( 'ca-google-font', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/custom-controls/google-fonts/script.js', array( 'ca-select2-js' ), '1.0', true );
			wp_enqueue_style( 'ca-google-font', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/custom-controls/google-fonts/style.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'ca-select2-css', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css', array(), '4.0.6', 'all' );
        }
		...
		public function to_json() {
			parent::to_json();
			$this->json['cafontslist'] = $this->fontList;
        }
		 ...
		 */
		private function getFontIndex( $haystack, $needle ) {
		 ...
		 */
		private function getGoogleFonts( $count = 30 ) {
