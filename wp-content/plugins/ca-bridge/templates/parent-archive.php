    ...
    <main id="main">
      ...
      <?php
        ...
        if ( have_posts() ) :
            ...
            if ($bridge_options['parent_archive_col_width'] ) 
				$columns = (int) $bridge_options['parent_archive_col_width'];
            ...
            while ( have_posts() ) :
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( "type-post clearfix" ); ?>>
                    ...
                    $width = $bridge_options['parent_archive_img_width'];
                    $height = $bridge_options['parent_archive_img_height'];
